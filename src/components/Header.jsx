      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-4">
        <div className="flex items-center">
          <img
            ...
            alt="logo-site"
          />
          <p className="text-primary-400 text-2xl">arthbnb</p>
        </div>

        <div className="flex items-center rounded-full border border-gray-300 py-2 pr-4 pl-6 shadow-md">
          <p className="border- border-r-gray-300 pr-4">Qualquer lugar</p>
          <p className="border- border-r-gray-300 px-4">Qualquer semanda</p>
          <p className="300 px-4">Hóspedes</p>
